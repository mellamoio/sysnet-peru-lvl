        ...
        <div class="row align-items-center">
            <div class="col-md-8 col-lg-8">
                ...
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('proveedores.index') }}">Lista de Clientes</a></li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                        <h6 class="card-subtitle">
                            Este es un formulario para crear un nuevo proveedor. Por favor, complete todos los campos
            ...
            <div class="col-lg-8">
                <div class="card m-b-30">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-12">
                                <h5 class="card-title mb-0">Todos los Proveedores</h5>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                            ...
                                            <td>
                                                <div class="button-list">
                                                    ...
                                                    <button type="button" class="btn btn-danger-rgba btn-delete-user"
                                                        ...
                                                        data-url="{{ route('proveedores.destroy', $proveedor->id) }}"
                                                        data-name="{{ $proveedor->razon_social }}">
